...
if __name__ == "__main__":
    ...
    parser.add_argument("-ucn", "--user-cluster-node", type=int, default=0)
    ...
    parser.add_argument("-uup", "--user-profile-update", type=int, default=0)
